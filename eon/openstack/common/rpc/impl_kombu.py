...
from eon.openstack.common import excutils
from eon.openstack.common.gettextutils import _, _LE, _LI
from eon.openstack.common import network_utils
from eon.openstack.common.rpc import amqp as rpc_amqp
from eon.openstack.common.rpc import common as rpc_common
from eon.openstack.common import sslutils

kombu_opts = [
    cfg.StrOpt('kombu_ssl_version',
               default='',
               help='If SSL is enabled, the SSL version to use. Valid '
                    'values are TLSv1 and SSLv23. SSLv2 might '
