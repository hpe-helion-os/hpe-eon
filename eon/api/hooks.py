...
from eon.conductor.v2 import rpcapi as rpcapi_v2
...
class DBHook(hooks.PecanHook):
    ...
    def before(self, state):
        ...
        state.request.dbapi = db.get_api()
        state.request.dbapi.setup_db_env()
...
class RPCHook(hooks.PecanHook):
    ...
    def before(self, state):
        state.request.rpcapi_v2 = rpcapi_v2.ConductorAPI()
